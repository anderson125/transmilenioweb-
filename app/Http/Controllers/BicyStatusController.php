...
class BicyStatusController extends Controller
{
    /**
    ...
    {
        return response()->json(BicyStatus::all());
    }
     ...
     *
     * @param  \App\Models\BicyStatus  $BicyStatus
     * @return \Illuminate\Http\Response
     */
    ...
    {
        return response()->json(BicyStatus::whereId($id)->first());
    }
    ...
    public function update(Request $request)
    {
        try {
            ...
            $data = BicyStatus::find($request->id);
            if (!$data) {
    ...
    {
        try {
            $data = BicyStatus::find($id);
            if (!$data) {
                return response()->json(['message' => 'Not Found', 'response' => ['id' => $id]], 404);
            }
            $data->delete();
            return response()->json(['message' => 'BicyStatus Deleted'], 200);
