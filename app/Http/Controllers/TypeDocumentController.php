...
class TypeDocumentController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validation = [
            "rules" => [
                'code' => 'required|min:2|max:10|unique:type_documents',
                'name' => 'required|min:6|max:100',
                'active' => 'required|in:1,2',
            ],
            "messages" => [
                'code.required' => 'El campo código es requerido',
                'code.min' => 'El campo código debe tener mínimo 2 caracteres',
    ...
    {
        return response()->json(TypeDocument::whereId($id)->first());
    }
