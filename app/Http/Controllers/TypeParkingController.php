...
class TypeParkingController extends Controller
{
    ...
    {
        return response()->json(TypeParking::all());
    }
     ...
     *
     * @param  \App\Models\TypeParking  $TypeParking
     * @return \Illuminate\Http\Response
     */
    ...
    {
        return response()->json(TypeParking::whereId($id)->first());
    }
    ...
    public function update(Request $request)
    {
        try {
            ...
            $data = TypeParking::find($request->id);
            if (!$data) {
